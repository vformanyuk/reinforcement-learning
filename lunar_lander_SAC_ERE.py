...
import os
from rl_utils.ERE_MemoryBuffer import ERE_MemoryBuffer
...
exp_buffer = ERE_MemoryBuffer(exp_buffer_capacity, env.observation_space.shape, env.action_space.shape, n=0.998)
...
for i in range(num_episodes):
    ...
    if global_step > 10 * batch_size:
        for states, actions, next_states, rewards, dones in exp_buffer(batch_size, epoch_steps):
