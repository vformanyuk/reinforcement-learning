...
It is representative and doesn't skip frames like some other envs, like ms-pacman for example.
...
Credits from SumTree implementation goes to [RL Code](https://github.com/rlcode)
